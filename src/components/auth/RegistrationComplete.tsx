...
function RegistrationComplete({ onNavigate }: RegistrationCompleteProps) {
        ...
        <div className="max-w-md w-full">
          ...
          <div className="backdrop-blur-xl bg-white/20 rounded-xl p-8 border border-white/30 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <div className="bg-green-50/80 backdrop-blur-sm border border-green-200/50 rounded-lg p-4 mb-4">
                <p className="text-sm text-green-800">
                  <strong>おめでとうございます！</strong> アカウントの登録が正常に完了しました。
                </p>
              </div>
              <div className="bg-blue-50/80 backdrop-blur-sm border border-blue-200/50 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  <strong>{countdown}秒後</strong> にダッシュボードに移動します...
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 px-6 py-3 border border-white/40 text-slate-700 rounded-lg hover:bg-white/20 transition-colors font-medium backdrop-blur-sm"
              >
